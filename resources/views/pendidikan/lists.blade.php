...
<div class="card">
  <div class="card-header">
    <h2 class="card-title">Master Pendidikan</h2>
    <small class="card-subtitle">Create, update & delete master pendidikan</small>
  </div>
  <div class="card-block">
    <div class="tab-container">
       <ul class="nav nav-tabs" role="tablist">
           <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" href="{{ route('users.index') }}" role="tab">Daftar Pendidikan</a>
           </li>
       </ul>
...
var table = $('#data-table-pendidikan').DataTable({
    autoWidth: false,
    responsive: true,
    ...
    columns: [
        ...
        { data: 'nm_pendidikan', name: 'nm_pendidikan' },
