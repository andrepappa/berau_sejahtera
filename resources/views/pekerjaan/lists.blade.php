...
<div class="card">
  <div class="card-header">
    <h2 class="card-title">Master Pekerjaan</h2>
    <small class="card-subtitle">Create, update & delete master pekerjaan</small>
  </div>
  <div class="card-block">
    <div class="tab-container">
       <ul class="nav nav-tabs" role="tablist">
           <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" href="{{ route('users.index') }}" role="tab">Daftar Pekerjaan</a>
           </li>
       </ul>
