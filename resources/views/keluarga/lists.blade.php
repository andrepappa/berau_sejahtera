...
<div class="card">
  <div class="card-header">
    <h2 class="card-title">Master Keluarga</h2>
    <small class="card-subtitle">Create, update & delete master keluarga</small>
  </div>
  <div class="card-block">
    <div class="tab-container">
       <ul class="nav nav-tabs" role="tablist">
           <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" href="{{ route('users.index') }}" role="tab">Daftar Keluarga</a>
           </li>
       </ul>
       <div class="tab-content">
         <div class="tab-pane active fade show" role="tabpanel">
           <a href="{{ route('register') }}" class="btn btn-primary waves-effect">Tambah Data</a>
           <div class="table-responsive">
             <table id="data-table-keluarga" class="table table-bordered">
...
var table = $('#data-table-keluarga').DataTable({
    autoWidth: false,
    responsive: true,
    ...
    columns: [
        ...
        { data: 'nm_keluarga', name: 'nm_keluarga' },
